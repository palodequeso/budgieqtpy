...
export default function CalendarExtrapolationCell({ entry, date, theme, extrapolation, setEditingCell }: { entry: CalendarEntry, date: string, theme: any, extrapolation: any, setEditingCell: any }) {
